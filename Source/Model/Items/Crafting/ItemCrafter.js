		...
		(
			...
			[
				...
				(
					...
					(
						this,
						(c) => c.itemEntityStagedSelected,
						(c, v) => { c.itemEntityStagedSelected = v; }
					), // bindingForItemSelected
					new DataBinding(null, (c) => c, null ), // bindingForItemValue
					null, null, null
				),
